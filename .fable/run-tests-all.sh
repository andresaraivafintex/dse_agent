...
T1="On the reports dashboard, show at a glance whether each report is still in progress or finished — a coloured badge, not just the page name buried in a column."
...
W1=$(disparar t1 "$T1"); log "teste1 disparado: $W1"; esperar "$W1" "teste1"
